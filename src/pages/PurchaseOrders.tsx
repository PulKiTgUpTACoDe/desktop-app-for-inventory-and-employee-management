...
const PurchaseOrders: React.FC = () => {
  ...
  const onSubmit = async (data: PurchaseOrderFormValues) => {
    ...
    try {
      ...
      if (res.success) {
        console.log("Purchase order created successfully, refreshing list...");
        ...
        console.error("Error creating purchase order:", res.error);
        alert(`Error creating purchase order: ${res.error}`);
      }
    } catch (error) {
